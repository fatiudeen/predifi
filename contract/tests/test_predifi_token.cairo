...
mod predifi_token_tests {
    ...
    fn test_token_transfer() {
        ...
        assert(final_sender_balance == initial_sender_balance - transfer_amount, 'Wrong sender balance');
        assert(final_recipient_balance == initial_recipient_balance + transfer_amount, 'Wrong recipient balance');
    }
    ...
    fn test_token_approval_and_transferFrom() {
        ...
        assert(owner_balance == 1000000000000000000000000_u256 - transfer_amount, 'Wrong owner balance');
    }
